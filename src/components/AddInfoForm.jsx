...
const AddInformationForm = () => {
    ...
    const [museumThumbnail, setMuseumThumbnail] = useState(null);
    const [otherPictures, setOtherPictures] = useState([null, null, null]);
    ...
    const handleThumbnailChange = (e) => {
        if (e.target.files.length > 0) {
            ...
            setMuseumThumbnail(URL.createObjectURL(file));
        } else {
    ...
    const handleOtherPicturesChange = (e, index) => {
        if (e.target.files.length > 0) {
            ...
            newOtherPictures[index] = URL.createObjectURL(file);
            setOtherPictures(newOtherPictures);
        }
    };

    const addOtherPicture = () => {
        setOtherPictures([...otherPictures, null]);
    };
            ...
            <div className="flex-1 p-4 overflow-y-auto ml-[250px] mt-16 pt-10 overflow-x-hidden">
                <div className="mx-10 my-11 space-y-5">
                    ...
                    <div className="flex flex-col justify-start space-y-4">
                        ...
                        <div className="flex flex-col justify-start space-y-4">
                            <div>
                                <h1 className="text-[#505050] font-bold text-[24px]">Add Other Pictures</h1>
                                <p className="text-[#505050]">*This section will be shown in visitor page</p>
                            </div>
                        ...
                        <div className="flex flex-col justify-start space-y-4">
                            ...
                            <div className="flex flex-row items-center justify-start space-x-5 px-5 py-4 border border-[#728969] w-[170px] rounded-md">
                                <input type="checkbox" className="w-5 h-5"/>
                                <h1>Wednesday</h1>
                            </div>
                            <div className="flex flex-row items-center justify-start space-x-5 px-5 py-4 border border-[#728969] w-[150px] rounded-md">
