...
const EditProfile = () => {
    ...
    return (
        <div className="flex-1 p-4 overflow-y-auto ml-[260px] mt-16 pt-10 overflow-x-hidden bg-[#F8F8F8]">
            <div className="mx-10 my-11 space-y-5">
                ...
                <div className='flex ml-3'>
                    <div className="items-center space-x-5 text-start mt-[2px] mb-1">
                        ...
                        />
                        <h1 className='font-extralight text-[10px] text-[#728969] mt-2'>click to change the photo</h1>
                    </div>
                    <div className='flex flex-row'>
                        <div className='ml-16'>
                            ...
                            <input
                                ...
                                className='border border-[#728969] rounded-[8px] w-[1250px] px-5 py-3 mt-2 font-extralight'
                            />
                            <h1 className='font-normal text-[16px] mt-4'>Last Name</h1>
                            <input
                                type="text"
                                value={lastName}
                ...
                <div className='flex flex-col ml-3'>
                    ...
                    <input
                        ...
                        className='border border-[#728969] rounded-[8px] w-[1472px] px-5 py-3 mt-2 font-extralight'
                    />
                    <h1 className='font-normal text-[16px] mt-4'>Phone Number</h1>
                    <input
                        type="tel"
                        value={phone}
                        ...
                        className='border border-[#728969] rounded-[8px] w-[1472px] px-5 py-3 mt-2 font-extralight'
                    />
                    <button className="bg-[#7F9275] w-[1472px] font-bold text-white rounded-[8px] px-4 py-3 mt-6" onClick={handleSaveIndividual}>
                        Save Changes
                    </button>
                    <h1 className="text-[#728969] text-[24px] font-bold mt-12">Change Password</h1>
                    <h1 className='font-normal text-[16px] mt-3'>Current Password</h1>
                    <div className='flex border border-[#728969] rounded-[8px] w-[1472px] px-5 py-3 mt-2 justify-between items-center'>
                        <div className="flex flex-row space-x-3 items-center font-extralight">
                    ...
                    <h1 className='font-normal text-[16px] mt-4'>New Password</h1>
                    <div className='flex border border-[#728969] rounded-[8px] w-[1472px] px-5 py-3 mt-2 justify-between items-center'>
                        <div className="flex flex-row space-x-3 items-center font-extralight">
                            <img src={PasswordIcon} alt="" />
                            <input
